...
class Basket
{
    ...
    public function __construct($quantity, $id = 0)
    {
    ...
    public function getBasketProduct(): array
    {
        return [
            "id" => $this->id,
    ...
    public static function convertProductsToTextArray(array $products): array
    {
        ...
        foreach ($products as $productObj)
            array_push($productsArray, $productObj->getBasketProduct());
    ...
    //     }
    // }
    public static function updateBasketProducts(array $products, mysqli $con = null)
    {
        if ($con === null) :
            $con = connectToDB();
        endif;
    ...
    public function updateBasketProduct(mysqli $con = null)
    {
        $prepStament = $con->prepare("UPDATE products SET 
        quantity=?,
        WHERE id=?");
        $prepStament->bind_param(
            "sssss",
    ...
    public static function convertBasketFromJSONToProduct($basket): Basket
    {
        return new Basket(
